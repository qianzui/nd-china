...
/**
 * 为了防止防火墙摇摇相应事件在弹出的对话框中触发
 * 
 * @author Administrator
 * 
 */
public class CustomDialogMain2 extends Dialog {

	public CustomDialogMain2(Context context) {
		super(context);
	}

	public CustomDialogMain2(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public CustomDialogMain2 create() {
			FireWallActivity.isInScene = false;
			LayoutInflater inflater = LayoutInflater.from(context);
			final CustomDialogMain2 dialog = new CustomDialogMain2(context,
		 ...
		 * 设置窗口参数
		 */
		private void setWindowParam(CustomDialogMain2 dialog) {
			// 取得窗口属性
