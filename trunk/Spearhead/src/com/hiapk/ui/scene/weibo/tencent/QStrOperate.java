...
public class QStrOperate {
     ...
     * 棄1�7查字符串是否存在倄1�7
     * 
     * @param str 待检验的字符丄1�7
     * @return 彄1�7 str 不为 null 戄1�7 "" 就返囄1�7 true
     */
     ...
     * 
     * @param paramDecString 待编码的参数字符丄1�7
     * @return 完成编码转换的字符串
     */
    ...
    /**
     * 射1�7 %XX 换为原符号，并进行UTF-8反编砄1�7
     * 
     * @param paramEncString 待反编码的参数字符串
     * @return 未进行UTF-8编码和字符替换的字符丄1�7
     */
    ...
    /**
     * 分割queryString，取得List&#60NameValuePair&#62格式存储的参数队刄1�7.
     * 
     * @param queryString 查询字符丄1�7
     * @return 以List&#60NameValuePair&#62格式存储的参数队刄1�7.
     */
    ...
    /**
     * 根据 timestamp 生成各类时间状�1�7�串
     * 
     * @param timestamp 跄1�770 00:00:00 GMT的秒敄1�7
     * @return 时间状�1�7�串(如：刚刚5分钟剄1�7)
     */
        ...
        try {
            ...
            if (System.currentTimeMillis() - _timestamp < 1 * 60 * 1000) {
                ...
                if (c.get(Calendar.YEAR) == now.get(Calendar.YEAR)
                    ...
                    SimpleDateFormat sdf = new SimpleDateFormat("M月d旄1�7 HH:mm:ss");
                    return sdf.format(c.getTime());
                } else {
                    SimpleDateFormat sdf = new SimpleDateFormat(
                            "yyyy年M月d旄1�7 HH:mm:ss");
                    return sdf.format(c.getTime());
                }
            }
        } catch (Exception e) {
